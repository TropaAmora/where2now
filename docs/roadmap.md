...
**Job system (Epic B) — in progress:** [stories/b1-job-domain-model.md](stories/b1-job-domain-model.md) · [stories/b2-job-lifecycle-management.md](stories/b2-job-lifecycle-management.md) · [stories/b3-celery-base-configuration.md](stories/b3-celery-base-configuration.md)
...
*Last updated: 2026-04-04 — added A5 story guide; A4 noted as implemented; added B1 and B2 story guides (job model and lifecycle service); B2 implemented. Added B3 story guide (Celery base configuration). Added tenant_id cross-cutting convention; applied to clients, delivery_points, and jobs tables.*